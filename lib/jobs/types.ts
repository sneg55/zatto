...
export interface StepBudgets { requests: number; dbQueries: number; seconds: number }
export const DEFAULT_BUDGETS: StepBudgets = { requests: 40, dbQueries: 40, seconds: 20 };
